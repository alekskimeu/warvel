...
const Characters = () => {
	...
	return (
		<div className="container mx-auto pt-10 pb-20 flex flex-col items-center px-2">
			...
			{characters.length > 0 ? (
				<div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 2xl:grid-cols-5 gap-3 mt-10 ">
